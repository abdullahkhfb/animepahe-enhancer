...
- **Auto Next:** When enabled, the extension listens for the local video ended event and follows animepahe's own "Play Next Episode" link. It does not send data to any external service or store additional watch history.
- **Auto Start:** When enabled, the extension clicks local page/player controls to load and start the current episode. It does not send data to any external service or store additional watch history.
