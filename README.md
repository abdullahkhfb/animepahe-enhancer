...
- **Auto Next** - Opens the next available episode automatically when playback ends. [Details&nbsp;→](docs/FEATURES.md#auto-next)
- **Auto Start** - Clicks the player load/play gates when an episode opens. [Details&nbsp;→](docs/FEATURES.md#auto-start)
