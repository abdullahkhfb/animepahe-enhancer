...
| Version   | Supported              |
| --------- | ---------------------- |
| `0.3.1.x` | ✅ Current release     |
| `< 0.3.1` | ❌ No longer supported |
...
| Component              | Behaviour                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Content scripts**    | Injected into `*.animepahe.{pw,org,com}`. Read and modify the DOM of those pages only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| **Network**            | Outbound requests go to `graphql.anilist.co` (Smart Search + Intro Skip ID resolution), `relations.yuna.moe` (Intro Skip ID resolution), `raw.githubusercontent.com` (timestamp DB download), and the animepahe origin itself (DUB detection). All animepahe requests pass through the `RequestThrottler` rate-limiter. As of `v0.3.1.1`, DUB detection's episode scan issues requests **sequentially, one at a time** (a gallop-then-binary-search over the episode list) rather than several in parallel per round, further reducing burst load against the animepahe origin. |
